...
<head>
    ...
    <title>Vereador São José da Varginha</title>
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold">Vereador</h1>
                        <p class="text-sm">São José da Varginha</p>
                    </div>
                </div>
                ...
                <div class="bg-blue-700 text-white rounded-lg p-6 md:p-8 shadow-lg">
                    <div class="flex flex-col md:flex-row items-center">
                        ...
                        <div class="md:w-2/3 md:pl-8">
                            <h2 class="text-2xl md:text-3xl font-bold mb-4">Vereador [Nome Completo]</h2>
